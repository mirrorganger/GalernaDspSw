...
// Applications/ThxDeepNote/app.cpp (a genuine HAL passthrough, not control logic) rather than
...
public:
    ...
    // Assumes the codec is already configured (see Applications/ThxDeepNote/app.cpp). Inits
