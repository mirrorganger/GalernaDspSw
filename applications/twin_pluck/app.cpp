...
// assumed from the firmware_core/inc/main.h pin names.
...
// SW1/SW2 gate the two fixed-pitch drone voices (TwinPluck::droneRootVoice/droneFifthVoice) --
// see TwinPluckApp's class comment for why a switch's on/off position maps onto the same
// noteOn()/noteOff() gate a button uses.
...
galerna::core::DuplexAudioBlockProcessor<audioFramesPerHalf, galerna::effects::TwinPluck, galerna::effects::CloudReverb>
...
// the host-testable TwinPluckApp class.
